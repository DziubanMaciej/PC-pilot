...
class ${message_class.name} private constructor(bytes: ByteArray, val address: InetSocketAddress) : Message(bytes) {
    ...
    companion object {
        ...
        fun fromBytes(bytes: ByteArray, length: Int, address: InetSocketAddress): List<${message_class.name}> {
            ...
            for (i in 0 until length step SIZE) {
                ...
                val message = ${message_class.name}(messageBytes, address)
